...
<h1 align="center">Umbrella Marketplace</h1>
...
- The name "Umbrella Market" is also copyright protected and should be changed to the name of your market.
...
If you are looking to fork Umbrella Market and create your own marketplace, you will find the following guides useful in our docs:

- [Forking Umbrella Market](https://docs.oceanprotocol.com/building-with-ocean/build-a-marketplace/forking-ocean-market)
...
Umbrella Market comes with prebuilt components for you to customize to cover GDPR requirements. Find additional information on how to use them below.
